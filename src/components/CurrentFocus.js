        ...
        <div className="twelve columns">
          <div className="info">
            ...
            <p>
              ...
              <ul className="disc">
                <li>Evidence-based improvement.</li>
                <li>Statistical analysis of historical trends.</li>
                <li>Build machine learning prototypes to make predictions based on historical data.</li>
                <li>Productize machine learning prototypes.</li>
                <li>Apply enterprise software practices to data science projects.</li>
              </ul>
            <p>
